...
<html>
    <head>
        ...
        <style><%@ include file="/css/styleViewStaffPage.css" %></style>  
    ...
    <body>
        <div class="headers">
            ...
            <!------Manage account / Login & Logout / Username------>
            ...
            <c:when test="${account.profile == 'DOCTOR'}">
                <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${admins}" var="admins" varStatus="status">
                                <c:if test="${(status.count % 2) == 0}">
                                    <tr class="table-secondary">
                                        <th scope="row">${admins.admin_id}</th>
                                        <td>${admins.first_name}</td>
                                        <td>${admins.last_name}</td>
                                        <td>${admins.email}</td>
                                        <td>${admins.mobile_phone}</td>
                                        <td>${admins.pref_contact_type}</td>
                                    </tr>
                                </c:if>
                ...
                <div class="table-responsive">
                    <h2 style="text-align: left;">Doctor</h2>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <c:forEach items="${doctors}" var="doctors" varStatus="status">
                                <c:if test="${(status.count % 2) == 0}">
                                    <tr class="table-secondary">
                                        ...
                                        <td>${doctors.email}</td>
                                        <td>${doctors.mobile_phone}</td>
                                        <td>${doctors.pref_contact_type}</td>
                                    </tr>
                                </c:if>
                                <c:if test="${(status.count % 2) == 1}">
                                    <tr>
